...
![Standard rank statistics critical-difference diagram (10% feature ratio) provided by FSEVAL.\label{fig:cdd-standard}](CD_Standard_AUC_10Percent.pdf){ width=80% }

![MARS magnitude-aware rank statistics critical-difference diagram (10% feature ratio) provided by FSEVAL.\label{fig:cdd-mars}](CD_MARS_AUC_10Percent.pdf){ width=80% }
